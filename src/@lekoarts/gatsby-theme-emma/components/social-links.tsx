...
const SocialLinks = () => (
  <>
  <a href="https://drive.google.com/file/d/1KbgITxZQvOTWd0fXFOYpVITN8T1lT-Sh/view?usp=sharing" target="_blank" rel="noopener noreferrer">
    ...
    <a href="https://github.com/MohamedMoussa1" target="_blank" rel="noopener noreferrer">
      <svg xmlns="http://www.w3.org/2000/svg"
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
    ...
    <a href="https://www.linkedin.com/in/mohamed-moussa-080414191/" target="_blank" rel="noopener noreferrer">
      <svg xmlns="http://www.w3.org/2000/svg" 
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
