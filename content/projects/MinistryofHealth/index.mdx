...
Through my 8 months workterm with the Ministry of Health (MOH), I had the chance to work on many interesting projects, one of which is building an Azure pipeline to automate and enhance the analysis process of data residing in excel files.
